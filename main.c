...
int dbgLevel = E_DBG_DEBUG;

int main(int argc, char *argv[])
{
    char a = 3;
    DBG_PRINTF(E_DBG_CRISIS, "326 %d \r\n", a);
    DBG_PRINTF(E_DBG_ERROR, "326 %d \r\n", a);
    DBG_PRINTF(E_DBG_WARNING, "326 %d \r\n", a);
    DBG_PRINTF(E_DBG_INFO, "326 %d \r\n", a);
    DBG_PRINTF(E_DBG_DEBUG, "326 %d \r\n", a);
